...
echo "# Look for the distribution with d64gsuwffb70l.cloudfront.net"
echo ""
...
echo "------------------"
echo "curl -I \"https://d64gsuwffb70l.cloudfront.net/FILENAME\""
echo ""
...
echo "5. Go to CloudFront Console → Find distribution for d64gsuwffb70l.cloudfront.net"
