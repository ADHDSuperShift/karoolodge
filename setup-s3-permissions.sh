...
echo "📋 STEP 4: Apply S3 CORS configuration"
echo "------------------------------------"
echo "To let browsers fetch from the bucket, apply the CORS rules:"
echo ""
echo "aws s3api put-bucket-cors \\" 
echo "  --bucket $BUCKET_NAME \\" 
echo "  --cors-configuration file://s3-cors-policy.json"
echo ""
echo "This enables GET/PUT/POST/DELETE/HEAD from any origin with the proper headers."
echo ""
...
echo "4. Image should display without 403/404 errors"
echo ""
